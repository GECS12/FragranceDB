...
class FragranceItem:
    def __init__(self, original_brand: str, original_fragrance_name: str, clean_brand: str,
                 website_clean_fragrance_name: Optional[str], final_clean_fragrance_name: str,
                 ...
                 price_alert_threshold: Optional[float] = None, is_in_stock: Optional[str] = None):  # Changed type
        ...
        self.is_in_stock = is_in_stock  # Changed type
    ...
    def to_dict(self):
        return {
            ...
            "is_in_stock": self.is_in_stock,  # Changed type
            "gender": self.gender,
